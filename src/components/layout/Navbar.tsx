    ...
    >
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        <div className="flex items-center gap-2">
          <SidebarTrigger />
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold text-medappt-primary hidden md:inline-block">CLÍNICA TESTE</span>
            <span className="text-xl font-bold text-medappt-primary md:hidden">CLÍNICA TESTE</span>
          </div>
        </div>
